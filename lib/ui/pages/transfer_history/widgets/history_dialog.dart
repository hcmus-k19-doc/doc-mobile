...
class HistoryDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (transferHistory.returnRequest == null) {
      ...
      if (transferHistory.returnRequest?.returnRequestType == "WITHDRAW") {
        return Dialog(
          child: Padding(
            padding: const EdgeInsets.all(StyleConst.defaultPadding12),
            child: Column(
              ...
              children: [
                Text(
                  AppLocalizations.of(context)!.withdrawProcess,
                  style: bodyLargeBold(context),
                ),
                const SizedBox(
                  height: StyleConst.defaultPadding16,
                ...
                TextRow(
                  title: AppLocalizations.of(context)!.petitioner,
                  content: transferHistory.senderName ?? "",
                ),
                const SizedBox(
                  height: StyleConst.defaultPadding8,
                ...
                TextRow(
                  ...
                  content: transferHistory.returnRequest?.reason ?? "",
                ),
                const SizedBox(
                  height: StyleConst.defaultPadding8,
                ),
                TextRow(
                  title: AppLocalizations.of(context)!.requestType,
                  content: AppLocalizations.of(context)!.selectRequestType(
                      transferHistory.returnRequest!.returnRequestType!),
                ),
                const SizedBox(
                  height: StyleConst.defaultPadding8,
                ),
                TextRow(
                  title: AppLocalizations.of(context)!.requestDate,
                  content: transferHistory.returnRequest?.createdAt ?? "",
                ),
                const SizedBox(
                  height: StyleConst.defaultPadding8,
                ),
        ...
        return Dialog(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  AppLocalizations.of(context)!.sendbackProcess,
                  style: bodyLargeBold(context),
                ),
                const SizedBox(
                  height: StyleConst.defaultPadding16,
                ...
                TextRow(
                  title: AppLocalizations.of(context)!.quotesRequest,
                  content: transferHistory.returnRequest?.reason ?? "",
                ),
                const SizedBox(
                  height: StyleConst.defaultPadding8,
